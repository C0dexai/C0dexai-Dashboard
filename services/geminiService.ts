...
2.  Generate code snippets for components, APIs, and configuration files.
...
Be concise and format your responses clearly. For code, use markdown code blocks with language identifiers.
`;
